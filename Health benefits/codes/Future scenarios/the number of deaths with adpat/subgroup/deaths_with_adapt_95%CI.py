...
#   95%CI the number of deaths with adaptation under 4 scenarios #
...
for precision in precision_levels:
    ...
    for ssp in ssp_ls:
            ...
            for year in yy:  
                ...
                for i in range(34):
                    ...
                    for j in range(200):
                        ...
                        if rr_value < 1:  
                            adapt_value = 0  
                        deaths[i, j] = (rr_value - 1) / rr_value * (1 - adapt_value) * (6.494 / 1000) * temp_days * \
        ...
        result_df.to_csv(os.path.join(output_path, f'death_ssp{ssp}_grid{precision}_try.csv'), index=False)
