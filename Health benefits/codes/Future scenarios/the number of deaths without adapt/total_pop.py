...
#  the number of deaths without adaptation under 4 scenarios #
...
for ssp in ssp_scenarios:
    ...
    for year in target_years:
        ...
        result.append({
            'year': year,
            f'{ssp}_death_non_ele': annual_death  
        })
    ...
    result_df.to_csv(os.path.join(output_path, f'{ssp}_death_non_ele.csv'), index=False)
