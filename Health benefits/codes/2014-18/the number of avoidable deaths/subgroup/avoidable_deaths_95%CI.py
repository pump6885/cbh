...
for dec_file in dec_files:
    ...
    for w in range(5):
        ...
        for j in range(200):
            ...
            death = pd.DataFrame(
                np.where(sub_ar < 0, 0 * 6494 * 229.0282,  adap * sub_ar * 6494 * 229.0282),
    ...
    res.to_csv('/Users/cbhbook/Desktop/95CI_dec_avoid_ele_grid'+flag+'.csv')


#   23-33  Celsius degree
folder_path = '/Users/cbhbook/Desktop/code/Health benefits/data/adapt_Monte Carlo'
new_path = '/Users/cbhbook/Desktop'
os.makedirs(new_path, exist_ok=True)
os.chdir('/Users/cbhbook/Desktop/code/Health benefits/data')
...
for inc_file in inc_files:
    ...
    for w in range(5):
        ...
        res = pd.concat([res, death], axis=0)
    res.index = list(np.arange(len(res)))
    res.to_csv('/Users/cbhbook/Desktop/95CI_inc_avoid_ele_grid'+flag+'.csv')
