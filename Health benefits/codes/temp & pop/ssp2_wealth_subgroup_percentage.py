...
income_cols = [
    'ssp2_income2030', 'ssp2_income2040', 'ssp2_income2050', 'ssp2_income2060',
    'ssp2_income2070', 'ssp2_income2080', 'ssp2_income2090', 'ssp2_income2100'
]
cat_cols = [
    'ssp2_cat_2030', 'ssp2_cat_2040', 'ssp2_cat_2050', 'ssp2_cat_2060',
...
for income_col, cat_col in zip(income_cols, cat_cols):
    ...
    output_path = '/Users/cbhbook/Desktop/ssp2_percentage.csv'
